...
//   const MaximizedView = () => (
//     <div className="fixed inset-0 z-50 overflow-hidden dark:bg-gradient-to-b dark:from-[#0A0A0A] dark:to-[#1a1a1a] bg-gradient-to-b from-white to-[#f5f5f5]">
//       <div className="h-full flex flex-col md:flex-row p-6 md:p-10">
//         {/* Left sidebar */}
//         <div className="w-full md:w-72 md:pr-6">
//           <h3 className="text-xl dark:text-white text-black mb-3 font-medium">{title}</h3>
//           <p className="text-sm dark:text-neutral-400 text-neutral-600 mb-6 leading-relaxed">{description}</p>
//           <div className="flex flex-wrap gap-2">
//             {tags.map((tag, index) => (
...
//             <div className="w-[85%] h-[85%] dark:bg-black bg-white rounded-xl flex items-center justify-center dark:border-neutral-800 border-neutral-200 border overflow-hidden">
//               {children}
//             </div>
//           </div>
//         </div>
  ...
  const MaximizedView = () => (
    <div className="fixed inset-0 z-50 overflow-hidden dark:bg-gradient-to-b dark:from-[#0A0A0A] dark:to-[#1a1a1a] bg-gradient-to-b from-white to-[#f5f5f5]">
      <div className="h-full flex flex-col md:flex-row p-0 md:p-10 relative">
        {/* Grid lines */}
        <div className="absolute inset-0 grid grid-cols-2 md:grid-cols-3 pointer-events-none">
          <div className="border-r border-gray-200 dark:border-gray-800"></div>
          <div className="md:border-r border-gray-200 dark:border-gray-800"></div>
        </div>
        ...
        {/* Left sidebar */}
        <div className="w-full md:w-72 p-6 md:p-0 md:pr-6 flex flex-col justify-between">
          <div>
            <h3 className="text-xl dark:text-white text-black mb-3 font-medium">{title}</h3>
            <p className="text-sm dark:text-neutral-400 text-neutral-600 mb-6 leading-relaxed">{description}</p>
            <div className="flex flex-wrap gap-2">
        ...
        <div className="flex-1 relative mt-6 md:mt-0">
          <div className="absolute inset-0 flex items-center justify-center p-6 md:p-0">
            <div className="w-full md:w-[85%] h-full md:h-[85%] dark:bg-black bg-white rounded-xl flex items-center justify-center dark:border-neutral-800 border-neutral-200 border overflow-hidden">
              {children}
            </div>
          </div>
        </div>
